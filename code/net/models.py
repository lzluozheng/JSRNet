...
from net.reconstruction_decoder import ReconstructionDecoderModified
...
class DeepLabCommon(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        if not os.path.isfile(cfg.MODEL.RECONSTRUCTION.SEGM_MODEL):
            raise RuntimeError(
                "=> pretrained segmentation checkpoints not found at '{}'".format(cfg.MODEL.RECONSTRUCTION.SEGM_MODEL))
